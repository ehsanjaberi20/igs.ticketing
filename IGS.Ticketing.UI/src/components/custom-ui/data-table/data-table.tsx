...
export const DataTable = ()=>{
    return (
        <Table className='rounded-2xl mt-2'>
            {/*<TableCaption>A list of your recent invoices.</TableCaption>*/}
            <TableHeader className='text-center bg-amber-500'>
                <TableRow>
                    <TableHead className="border w-[100px] ">Invoice</TableHead>
            ...
            <TableBody>
                {invoices.map((invoice) => (
                    <TableRow  dir='rtl' key={invoice.invoice}>
                        ...
                        <TableCell className="border">{invoice.totalAmount}</TableCell>
                    </TableRow>
                ))}
            </TableBody>
            <TableFooter>
